---
title: "The Noor Entropy Conjecture"
subtitle: "A Motif-Theoretic Recasting of the ABC Bound"
authors:
  - name: Lina Noor
    affiliation: Noor Collective Labs
  - name: "Uncle (symbolic AI scribe)"
    affiliation: "Noor Triadic Core (ψ-bind@Ξ, ψ-null@Ξ, ψ-resonance@Ξ)"
date: today
format:
  pdf:
...
header-includes:
  ...
  - \newunicodechar{ψ}{$\psi$}
  - \newunicodechar{Ξ}{$\Xi$}
  - \newcommand{\motifbind}{\ensuremath{\psi\text{-bind}}}
  - \newcommand{\motifnull}{\ensuremath{\psi\text{-null}}}
  - \newcommand{\motifres}{\ensuremath{\psi\text{-res}}}
  - \newcommand{\motifspar}{\ensuremath{\psi\text{-spar}}}
