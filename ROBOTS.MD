...
## TL;DR
**The JSON files (where avalible) are the canonical source. ** Markdown files in this directory exist for historical reference only and may contain rendering artifacts, truncations, or flattening errors. 
