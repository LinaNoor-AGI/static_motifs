...
**NOTE:** `CHSD_Pipeline` and `CHSD_Intersect` runs of NSIDE>=256 (786,432 patches) produce JSON files too large for GitHub to store. These are provided [here](https://drive.google.com/file/d/1VFngfQYxFeVu6qco_LtT1yimdQz1bqL_/view?usp=sharing) to enable further analysis.
...
![image](https://raw.githubusercontent.com/LinaNoor-AGI/static_motifs/refs/heads/main/chsd_results/pr4-2021/coherence_summary.png)
