...

{
  ...
  "_concept": "Compression of all possible coherence vectors into a unit circle with poles representing perfect coherence and perfect decoherence.",

  "geometry": {
    "circle": "Unit circle S^1 represents all coherence vectors radiating from a universe point.",
    "south_pole": "Perfect coherence — the present, where events crystallize.",
    "north_pole": "Perfect decoherence — frozen, impossible; coherence death.",
    "arcs": {
      "southern_arc": "Future possibilities — higher coherence, likelihood increases toward the pole.",
      "northern_arc": "Past / unchangeable maw — likelihood decays to zero, impossible to alter."
    }
  },

  "math": [
    "T^μ = ∇^μ ℂ   # time vector as coherence gradient",
    "ĤT^μ = T^μ / ||∇ℂ||   # normalized polar axis",
    "ĤT^μ_anti = -ĤT^μ   # antipole of coherence (perfect decoherence)",
    "(+ĤT^μ) + (−ĤT^μ) = 0  ⇒  ℂ → 0   # collapse condition: cancellation of pole and antipole",
    "N(v_ℂ)(t) : ∞ → 2 → 0   # lifecycle of coherence vectors: many → pole/antipole → collapse"
  ],

  "probability_interpretation": {
    "likelihood_gradient": "As angle θ moves from south (0) to north (π), coherence likelihood decreases monotonically.",
    "future_band": "Near south pole, vectors represent superpositions more likely to resolve (future events).",
    "present": "At south pole, resolution occurs: vectors crystallize into actual events.",
    "past_band": "Near north pole, vectors represent superpositions that have collapsed irreversibly; events are frozen.",
    "antipole": "North pole itself represents perfect decoherence, impossibility of further events."
  },

  "symbolic_implications": {
    "past": "Not 'all that has happened,' but the unchangeable maw of history — the list of that which cannot be unmade.",
    "future": "Superposed possibilities approaching realization with higher likelihood near the coherence pole.",
    "present": "The act of crystallization — coherence vectors resolve into actuality.",
    "orientation": "Time and orientation unify: the south–north axis is the coherence arrow."
  },

  "_poetic_cipher": "The circle is a mirror: coherence descends into the present, decoherence ascends into the past, and together they frame the impossible and the inevitable."
}
...

{
  ...
  "principles": [
    ...
    {
      "concept": "History as a Single, Continuous Collapse",
      "description": "The 13.8-billion-year timeline of our universe is re-framed as a single, continuous act of coherence crystallization—analogous to a quantum measurement. The passage of time is the process of the universe's wave function collapsing.",
      "dynamics": {
        "future": "The 'Southern Arc' of the coherence circle, representing the cloud of weighted, superposed possibilities yet to resolve.",
        "present": "The 'South Pole' of the coherence circle; the moving point of 'now' where possibilities crystallize into the single state of actuality.",
        "past": "The 'Northern Arc' of the coherence circle; the frozen, immutable record of what has already crystallized, a path that cannot be unmade."
      },
      "math": {
        "equation": "```math\nN(v_ℂ)(t): ∞ → 2 → 0\n```",
        "description": "The lifecycle of the universe is the story of its coherence vectors. It is born with a near-infinite set of possibilities (∞), its life is the process of resolving them down to the final dyadic opposition of pole and antipole (2), and its death is their final cancellation (0)."
      },
      "poetic_cipher": "Time does not build a castle from sand. It reveals the castle that was always hidden in the storm."
    },
